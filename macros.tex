...
%% General 
	\input{Submodules/Theorem Environments} % Defines theorems notations
...
\input{Submodules/Category Theory}
%\input{Submodules/Coarse Graining and Sheaf Theory}
\input{Submodules/Conceptual Spaces}
\input{Submodules/Inline Notation for CQM}
%\input{Submodules/Lattice Theory}
%\input{Submodules/Modadic Dynamics}
\input{Submodules/Set Theory}
%\input{Submodules/Topology and Linear Algebra}
