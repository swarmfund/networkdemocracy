...
%% General 
	\subimport{Submodules}{Theorem Environments} % Defines theorems notations
...
\subimport{Submodules}{Category Theory}
%\subimport{Submodules}{Coarse Graining and Sheaf Theory}
\subimport{Submodules}{Conceptual Spaces}
\subimport{Submodules}{Inline Notation for CQM}
%\subimport{Submodules}{Lattice Theory}
%\subimport{Submodules}{Modadic Dynamics}
\subimport{Submodules}{Set Theory}
%\subimport{Submodules}{Topology and Linear Algebra}
