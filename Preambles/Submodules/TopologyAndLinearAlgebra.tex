...
\newcommand{\spacedefinition}[1]{\ensuremath{#1}\xspace}

% Defines the standard style for a category (bold)
\newcommand{\spacename}[1]{\spacedefinition{\mathcal{#1}}}

%% General purpose space names 
	\newcommand{\SpaceH}{\spacename{H}} 
	\newcommand{\SpaceG}{\spacename{G}}
	\newcommand{\SpaceK}{\spacename{K}}
	\newcommand{\SpaceA}{\spacename{A}}
	\newcommand{\SpaceB}{\spacename{B}}
...
%% Sets and spans
	...
	\newcommand{\Ltwo}[1]{\spacedefinition{\LtwoSym[#1]}} % L2 space over space #1
