...
\section{Proposals and kinds}
	...
	\begin{example}\label{ex:subkind}
		...
		\begin{figure}[h]
			...
			\end{tikzpicture}
			\caption{The expression $\textbf{rules}_C \wedge \neg\textbf{rules/voting.procedures}_C$ endorses the red area to $v$ and the blue area to $u$.}\label{fig:endorsing statements}
		\end{figure}
	\end{example}
